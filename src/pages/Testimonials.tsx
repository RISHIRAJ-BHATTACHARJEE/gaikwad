    ...
    <div className="bg-gradient-to-r from-[#24343BCC] to-[#17262A] montserrat-regular text-white">
      ...
      <div className="grid grid-cols-5 grid-rows-2 mt-8">
        <div className="col-start-1 row-start-2 -translate-y-10 -translate-x-1">
          <img src="/testimonial-image1.png" alt="" className="w-13 md:w-26" />
        </div>
      ...
      <div className="flex flex-col gap-8">
        ...
        <p className="text-sm md:text-lg text-center px-6">
...
const TestimonialCard = () => {
  return (
    <div className="p-6 md:p-8 mx-12 md:mx-32 flex flex-col gap-4 md:gap-10 rounded-2xl border border-white/20 backdrop-blur-[50px] shadow-[0_16.54px_33.03px_rgba(0,0,0,0.1)] bg-white/15">
      <div className="flex items-center gap-2 md:gap-3">
        <img src="/review-avatar.png" alt="review-avatar" className="w-10 md:w-14" />
