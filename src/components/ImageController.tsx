...
const ImageController = ({
  ...
  return (
    <div className="relative w-full 2xl:mr-0! lg:w-5/6 2xl:w-[94%] lg:items-start md:my-6 my-5 max-w-4xl h-[10vh] md:h-[12vh] 2xl:h-[10vh] flex items-center justify-center overflow-hidden">
      <button
        onClick={prev}
