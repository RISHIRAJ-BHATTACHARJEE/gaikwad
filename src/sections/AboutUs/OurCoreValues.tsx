  ...
  return (
    <div className="bg-gradient-to-l from-[#17262A] to-[#24343BCC] text-white py-12 md:py-18">
      ...
      <div className="grid grid-cols-2 gap-20 m-12 items-center justify-between text-center">
        ...
        {/* Transparency */}
        <div className="flex flex-col items-center justify-between gap-2 md:gap-3">
          <img src="/icons/transparency.png" alt="Transparency" className="w-10 md:w-12"/>
