...
const Slide = ({ card, index, current, handleSlideClick }: SlideProps) => {
  ...
  return (
    <div className="[perspective:400px] md:[perspective:2000px] [transform-style:preserve-3d]">
      <li
        ref={slideRef}
        className="flex flex-1 flex-col items-center justify-center relative text-center text-white transition-all duration-300 ease-in-out w-[270px] md:w-[370px] h-[415px] md:h-[585px] mx-[4vmin] z-10"
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <p className="text-white text-xs md:text-lg font-light leading-5 md:leading-7">
              {card.review}
            </p>
